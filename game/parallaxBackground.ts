...
const backgroundImg = '/assets/background/layers/parallax-mountain-bg.png'
const mountainsImg = '/assets/background/layers/parallax-mountain-mountains.png'
const treesImg = '/assets/background/layers/parallax-mountain-trees.png'
const foregroundTreesImg = '/assets/background/layers/parallax-mountain-foreground-trees.png'
const farMountainImg = '/assets/background/layers/parallax-mountain-montain-far.png'
